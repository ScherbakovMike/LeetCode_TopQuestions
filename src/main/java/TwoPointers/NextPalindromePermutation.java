...
public class NextPalindromePermutation {
    ...
    public static void main(String[] args) {
        var nums = new int[]{3, 2, 20, 16, 1, 15, 15, 14, 27, 26, 5, 16, 9, 13, 17, 24, 15, 12, 15, 14, 27, 14, 14, 3, 20, 7, 18, 6, 8, 8, 24, 3, 11, 14, 19, 12, 0, 26, 18, 19, 22, 16, 6, 24, 29, 15, 10, 14, 28, 17, 21, 17, 2, 27, 12, 22};
