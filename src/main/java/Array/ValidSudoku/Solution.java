  ...
  public boolean isValidSudoku(char[][] board) {
    ...
    for (int rowNumber = 0; rowNumber < board.length; rowNumber += 3) {
      ...
      for (int columnNumber = 0; columnNumber < row.length; columnNumber += 3) {
        var items = IntStream.of(
                board[rowNumber][columnNumber], board[rowNumber][columnNumber + 1],
                board[rowNumber][columnNumber + 2],
                board[rowNumber + 1][columnNumber], board[rowNumber + 1][columnNumber + 1],
                board[rowNumber + 1][columnNumber + 2],
                board[rowNumber + 2][columnNumber], board[rowNumber + 2][columnNumber + 1],
