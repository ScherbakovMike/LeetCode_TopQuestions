...
public class SplitACircularLinkedList {
  ...
  public ListNode[] splitCircularLinkedList(ListNode list) {
    ...
    // fast is the end node
    // slow is the end of the first half
    // [list, slow] [slow.next, fast]
...
//        Arrays.toString(new SplitACircularLinkedList().splitCircularLinkedList(test2)));
    ...
    System.out.println(
        Arrays.toString(new SplitACircularLinkedList().splitCircularLinkedList(test3)));
  }
}
