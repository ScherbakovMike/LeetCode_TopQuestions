...
public class PartitionToKEqualSumSubsetsOptimized {
    ...
    public boolean canPartitionKSubsets(int[] nums, int k) {
        ...
        nums = Arrays.stream(nums).boxed().sorted(Comparator.reverseOrder()).mapToInt(item -> item).toArray();
    ...
    private boolean backtrack(int[] nums, int index, int count, int curSum, int k, int targetSum,
                              boolean[] taken) {
    ...
    public static void main(String[] args) {
        System.out.println(new PartitionToKEqualSumSubsetsOptimized().canPartitionKSubsets(
